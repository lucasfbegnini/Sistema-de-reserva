...
export class LoginAuthDto {
  @ApiProperty({ example: 'admin@exemplo.com', description: 'Endereço de e-mail único do usuário', format: 'email' })
  ...
  @ApiProperty({ example: 'adminpassword123', description: 'Senha do usuário (mínimo 8 caracteres)', format: 'password' })
  @IsString() // Validador
